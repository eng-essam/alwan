<div>
                                                ...
                                                <td>
                                                    <div style="width: max-content;margin: auto;" class=" d-flex">
                                                        <button style="margin: 3px"
                                                                wire:click.prevent="sendExecution({{$order->id}})"
                                                                data-toggle="modal"
                                                                data-target="#sendExecutionModal"
                                                                class="btn btn-success  btn-xs btn-rounded">
                                                            {{__('lang.send_execution')}}
                                                        </button>
    ...
    <!-- ends: .send Execution Modal -->
    <div wire:ignore.self class="modal-info-delete modal fade show" id="sendExecutionModal" tabindex="-1"
         role="dialog"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="modal-info-body d-flex">
                        ...
                        <div class="modal-info-text">
                            <p>{{__('lang.sorting_files_desc')}}</p>
                        </div>
                    </div>
