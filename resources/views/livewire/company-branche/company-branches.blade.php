<div style="margin-top: 20px" class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div style="font-size: 20px;font-weight: bold;" class="card-header color-dark fw-500">
                    ...
                    <div>
                        <button style="font-size: 15px" data-toggle="modal" data-target="#addCompanyModal"
                ...
                <div style="width: 50%;margin: auto;margin-top: 15px" class="input-group ">
                    ...
                    <input wire:model="searchCompany" type="text" class="form-control"
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tr style="text-align: center" class="userDatatable-header">
                                    ...
                                    <th>
                                        <span style="font-weight: bold;font-size: 15px;"
                                              class="userDatatable-title">{{__('lang.company_name')}}</span>
                                    </th>

                                    <th>
                                        <span style="font-weight: bold;font-size: 15px;"
                                              class="userDatatable-title">{{__('lang.company_address')}}</span>
                                    </th>
                                ...
                                <tbody>
                                @foreach($allCompanyBranch as $company)
                                    <tr style="text-align: center;">
                                        <td>
                                            <div style="font-size: 15px" class="userDatatable-content">
                                                {{$allCompanyBranch->firstItem()+$loop->index}}
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div style="width: max-content;margin: auto;" class=" d-flex">
                                                <button style="margin: 3px"
                                                        wire:click.prevent="editeCompany({{$company->id}})"
    ...
    <!-- start: add_ Company -->
    <div wire:ignore.self class="modal-info-delete modal fade show" id="addCompanyModal" tabindex="-1" role="dialog"
         aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content modal-bg-white ">
                <div class="modal-header">
                    <h6 class="modal-title">{{__('lang.add_branche')}}</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span data-feather="x"></span></button>
                </div>
                <form wire:submit.prevent="submitAddBranche">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-25">
                                <label>{{__('lang.address_ar')}}</label>
                                <textarea wire:model="address_ar" class="form-control" id="exampleFormControlTextarea1"
                                          rows="5"></textarea>
                                @error('address_ar')
                                <small style="color: red">{{ $message }}.</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-25">
                                <label>{{__('lang.address_en')}}</label>
                                <textarea wire:model="address_en" class="form-control" id="exampleFormControlTextarea1"
                                          rows="5"></textarea>
                                @error('address_en')
                                <small style="color: red">{{ $message }}.</small>
                                @enderror
    ...
    <!-- start: edit Company -->
    <div wire:ignore.self class="modal-info-delete modal fade show" id="editCompanyModal" tabindex="-1" role="dialog"
         aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content modal-bg-white ">
                <div class="modal-header">
                ...
                <form wire:submit.prevent="submitEditCompany">
                    <div class="modal-body">
                        <div class="row">
    ...
    <div wire:ignore.self class="modal-info-delete modal fade show" id="deleteCompanyModal" tabindex="-1" role="dialog"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="modal-info-body d-flex">
                        ...
                        <div class="modal-info-text">
                            <h6>{{__('lang.delete_branch_information')}}</h6>
                            <p>{{__('lang.delete_branch_information_desc')}}</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click="submitDeleteCompany"
